...
int main()
{
	...
	*/
	...
	//                Short-circuit Evaluation
	// ////////////////////////////////////////////////////////
	// When the result of the left side is false, 
	// the right side of expression will not be executed.
	// ////////////////////////////////////////////////////////
	//if (temp == 0 && (++temp == 1024))
	//{
	//	// do nothing
	...
	// ////////////////////////////////////////////////////////
	// &&and || are sequence points 
	// A sequence point defines 
	//     any point in a computer program's execution
	//// ////////////////////////////////////////////////////////
	//int x = 1, y = 2;
	//if (x++ > 0 && x + y == 4)
	//{
